...
const CRAGS = [
  ...
  },
  {
    ...
    "visits": [
      {
        "date": "2026-06-27",
        "with": "Japo, SaraG, Ire, Luca",
        "routes": [
          {
            "name": "Via Harlem",
            "grade": "5b",
            "comment": "Tutta placca, molto sporca (questo ha alzato la difficoltà parecchio perchè si scivolava). Un cado boia, da fare in autunno/primavera, è in ombra fino alle 11 circa"
          }
        ]
      }
    ]
